"""
源代码来源于https://blog.csdn.net/wodeyan001/article/details/86703034
"""
import calendar
...
class Calendar:
    ...
    def selection(self):
        ...
        year, month = self._date.year, self._date.month
        ymd = str(datetime(year, month, int(self._selection[0])))[:10]
        return "{}{}{}".format(ymd[0:4], ymd[5:7], ymd[8:10])
...
if __name__ == '__main__':
    a = Calendar((160, 100), 'lr').selection()
    print(a)
    #b = '2020-11-19'
    #print("{}{}{}".format(b[0:4], b[5:7], b[8:10]))
